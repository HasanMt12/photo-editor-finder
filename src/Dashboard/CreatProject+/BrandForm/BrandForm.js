        ...
        <div>
           <form novalidate="" action="" className=" flex flex-col mx-auto w-full ">
                ...
                <div className='flex justify-between items-start mt-[59px]'>
                   <div className='mt-12'>
                        <h5 className='text-[#090D28] text-lg font-medium'>Titling</h5>
                    ...
                    <div  className="w-[75%] h-[165px] rounded-md border-[0.5px] border-[#D2D2D2] py-10 px-14" spellcheck="false">
                        <div className='flex justify-start items-center gap-3'>
                        <div className="  w-[40%] h-[49px] my-2"> 
                            <label for="state" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Opening Title</label>
                            <input id="state" type="text" placeholder="4449 E Fountain St, Mesa, AZ 85205" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                        <div className=" w-[40%] h-[49px] my-2 ">
                            <label for="zip" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Ending Title</label>
                            <input id="zip" type="text" placeholder="4449 E Fountain St, Mesa, AZ 85205" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div className='flex justify-between items-start mt-[59px]'>
                   <div className='mt-12'>
                        <h5 className='text-[#090D28] text-lg font-medium'>Agent Information </h5>
                        <div className='w-[296px] h-[40px] mt-2'>
                            <h5 className='text-[#6B6F86] text-sm font-medium'>Wrolds first-class photo editing services whether you are a freelancer photographer, </h5>
                        </div>
                    </div>
                 ...
                 <div className='w-[75%] h-auto'>
                     ...
                     <div className='flex justify-start items-center gap-3'>
                        <div className=" w-[50%] h-[49px] my-2"> 
                            <label for="state" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">First Name</label>
                            <input id="state" type="text" placeholder="Farhad" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                        <div className=" w-[50%] h-[49px] my-2 ">
                            <label for="zip" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Last Name</label>
                            <input id="zip" type="text" placeholder="Ahmed" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                     </div>
                      <div className='flex justify-start items-center gap-3 mt-6'>
                        <div className=" w-[50%] h-[49px] my-2"> 
                            <label for="state" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Mobile Number</label>
                            <input id="state" type="text" placeholder="+9110000000" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                        <div className=" w-[50%] h-[49px] my-2 ">
                            <label for="zip" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Office Number</label>
                            <input id="zip" type="text" placeholder="+9105456000" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                     </div>
                     <div className='flex justify-start items-center gap-3 mt-6'>
                        <div className=" w-[50%] h-[49px] my-2"> 
                            <label for="state" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Company Name</label>
                            <input id="state" type="text" placeholder="photo Sher" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                        <div className=" w-[50%] h-[49px] my-2 ">
                            <label for="zip" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Email</label>
                            <input id="zip" type="text" placeholder="example@photosher.com" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
                     </div>
                     <div className='flex justify-start items-center gap-3 mt-6'>
                        <div className=" w-[100%] h-[49px] my-2"> 
                            <label for="state" className="text-[#090D28] text-[16px] leading-[-0.33px]  font-medium">Website Domain</label>
                            <input id="state" type="text" placeholder="photoSher.com" className="w-full mt-2 px-3 h-[49px] rounded-md  border-[#D2D2D2] border-[1px] rounded--[4px] text-gray-900" />
                        </div>
