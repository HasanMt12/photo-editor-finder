...
const Signup = () => {
  ...
  return (
    <div className="flex items-center ">
      ...
      {/* Signup */}
      <div className=" h-screen py-12 px-20 mx-auto">
        <div className="py-1">
          <h1 className="text-3xl font-bold text-gray-800">
            Welcome to photosher!!
          </h1>
          <p className="text-base text-gray-500 pt-2">
            Let’s Create your Photoque account and get started
          </p>
        </div>
        <form className="w-[560px] mx-auto">
          <div class="grid grid-cols-1 gap-6 mt-2 md:grid-cols-2 pb-2">
            <div>
              <label class="block mb-2 text-lg ">First Name</label>
              <input
                type="text"
                placeholder="John"
                class="block w-full px-5 py-1 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-400 rounded-lg     focus:outline-blue-600"
              />
            </div>

            <div>
              <label class="block mb-2 text-lg ">Last name</label>
              <input
                type="text"
                placeholder="Snow"
                class="block w-full px-5 py-1 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-400 rounded-lg      focus:outline-blue-600  "
          ...
          <div className="pb-2 ">
            <label htmlFor="website" className="block mb-2 text-lg">
              Company Website{" "}
            ...
            <input
              ...
              className="w-full  px-5 py-1 border rounded-md border-gray-400  text-gray-50 text-lg 
               focus:outline-blue-600"
              data-temp-mail-org="0"
            />
          </div>
          <div class="grid grid-cols-1 gap-6  md:grid-cols-2 pb-2">
            <div>
            ...
            <div>
              <label class="block mb-2 text-lg">Phone number</label>
              <PhoneInput
                international
                countryCallingCodeEditable={false}
                defaultCountry="IN"
                value={value}
                className="block w-full px-5 py-1 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-400 rounded-lg      focus:outline-blue-600"
                onChange={setValue}
              />
            </div>
          </div>
          <div className="pb-2">
            ...
            <div className="relative ">
              <input
                ...
                id="password"
                placeholder="abcd"
                className="w-full  px-5 py-1 border rounded-md border-gray-400  text-gray-50 text-lg focus:outline-blue-600"
                data-temp-mail-org="0"
              />
...
<div className="pt-2 ">
<label class="block mb-2 text-lg  ">How did you hear about us ?</label>
<div class="flex items-center justify-between pb-2 text-lg  ">
            
            <label class="inline-flex items-center">
             
              <input type="radio" id="html" name="social-site" value="Linkedin" class="form-radio  bg-white border border-gray-400 rounded text-gray-700 mr-2"/>
              <span class="text-gray-500">Linkedin</span>
            </label>
          
            <label class="inline-flex items-center ">
            <input type="radio" id="html" name="social-site" value="Instagram" class="form-radio  bg-white border border-gray-400 rounded text-gray-700 mr-2"/>
              <span class="text-gray-500">Instagram</span>
            </label>
          
            <label class="inline-flex items-center ">
            <input type="radio" id="html" name="social-site" value="Youtube Ads" class="form-radio  bg-white border border-gray-400 rounded text-gray-700 mr-2"/>
              <span class="text-gray-500">Youtube Ads</span>
            </label>
          
            <label class="inline-flex items-center ">
            <input type="radio" id="html" name="social-site" value="Google" class="form-radio  bg-white border border-gray-400 rounded text-gray-700 mr-2"/>
              <span class="text-gray-500">Google</span>
            </label>
            <label class="inline-flex items-center ">
            <input type="radio" id="html" name="social-site" value="Other" class="form-radio  bg-white border border-gray-400 rounded text-gray-700 mr-2"/>
...
<label htmlFor="website" className="block mb-2 text-lg">
              If Other{" "}
              <span className="text-sm text-gray-600">(Please Specify)</span>
            </label>
            <div className="relative ">
              <input
                type="password"
          ...
          <div>
            <div class="flex justify-center items-center pt-2">
              <label for="accept" className="flex justify-center ">
                <input
                  type="checkbox"
                  id="accept"
                  name="marketing_accept"
                  class="h-4 w-5 mr-3 mt-1 cursor-pointer border-gray-200 bg-white shadow-sm"
                />

                <span class="text-base cursor-pointer  ">
                  By Signing in, you’ve agreed to our{" "}
                  <span className="text-[#5E75FB]">Terms & Conditions </span>{" "}
                  and <span className="text-[#5E75FB]">Privacy Policy</span>
                </span>
              </label>
            </div>
          </div>
          <button
            type="submit"
            className="w-full py-2 font-semibold mt-5 text-lg  tracking-wide  rounded-md bg-[#324FF6] hover:bg-blue-700 text-white"
          >
            Sign up
          </button>
        </form>

        <div class="flex items-center justify-center py-3 text-center bg-gray-50 ">
          <span class="text-lg text-black ">Already have an account? </span>

          <Link
            to="/"
            class="mx-2 text-lg font-bold text-blue-500  hover:underline"
          >
            Sign in
          </Link>
        </div>
