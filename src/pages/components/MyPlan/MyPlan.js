    ...
    onChange={(e)=>setActiveTab(e)}
      ...
      renderMark={mark => {
        if ([ 1 ,2 ,3 , 4, 5, 6 ].includes(mark)) {
          ...
          if(mark === 1 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>0 - 500$</span></div>
                    <span className='rangText2'>0 - 500 credits</span>
                </div>
          }
            if(mark === 2 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>501 - 1000$</span></div>
                    <span className='rangText2'>501 - 1000 credits</span>
                </div>
          }
           if(mark === 3 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>1001 - 1500$</span></div>
                    <span className='rangText2'>1001 - 1500 credits</span>
                </div>
          }
           if(mark === 4 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>1501 - 2000$</span></div>
                    <span className='rangText2'>1501 - 2000 credits</span>
                </div>
          }
           if(mark === 5 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>2001 - 2500$</span></div>
                    <span className='rangText2'>2001 - 2500 credits</span>
                </div>
          }
          if(mark === 6 ){
                return <div className='rangText'> 
                   <div><span className='rangText1'>2501 - 3000$</span></div>
